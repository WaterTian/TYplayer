...
TY.videoBgTemplate='<div class="h5_player_bg" style="position:absolute;width:100%;height:100%;top:0;background-position:center;background-size: cover; background-color:transparent;;background-image:url()"></div>',TY.dpr=window.devicePixelRatio||1,TY.isAndroid=/Android/i.test(navigator.userAgent),TY.isIphone=/iphone/i.test(navigator.userAgent),TY.isChrome=/chrome\//i.test(navigator.userAgent),TY.isWeixin=/MicroMessenger\//i.test(navigator.userAgent),TY.isWeibo=/Weibo/i.test(navigator.userAgent),TY.isMobileDevice=isMobileDevice,TY.formatTime=function(a){var b="",c=parseInt(a),d=c%60,e=parseInt(c/60),f=0;return e>60&&(f=parseInt(e/60),e=parseInt(e%60)),10>e&&(e="0"+e),10>d&&(d="0"+d),10>f&&(f="0"+f),b=f+":"+e+":"+d},TY.EventDispatcher=function(){},TY.EventDispatcher.prototype={constructor:TY.EventDispatcher,addEventListener:function(a,b){return this._listeners?this.removeEventListener(a,b):this._listeners={},this._listeners[a]||(this._listeners[a]=[]),this._listeners[a].push(b),b},hasEventListener:function(a,b){var c=this._listeners;return!(!c||!c[a])},removeEventListener:function(a,b){if(this._listeners&&this._listeners[a])for(var c=this._listeners[a],d=0,e=c.length;d<e;d++)if(c[d]==b){1==e?delete this._listeners[a]:c.splice(d,1);break}},removeAllEventListeners:function(a){a?this._listeners&&delete this._listeners[a]:this._listeners=null},dispatchEvent:function(a,b){var c=!1,d=this._listeners;if(a&&d){var e=d[a];if(!e)return c;e=e.slice();for(var f,g=e.length;g--;){var f=e[g];c=c||f(b)}}return!!c}},TY.TYskin=function(a,b,c){_TYskin=this;var d=a,e=b;_isLive=c,e.append(TY.templates.replay),pause=$(".h5_player_pause"),waiting=$(".h5_player_waiting"),warning=$(".h5_player_warning"),tip_btn=$(".h5_player_tip_btn"),process_bar=$(".h5_player_process_bar"),process_forward=$(".h5_player_process_forward"),tip_btn.height(tip_btn.height()-60*TY.dpr),pause.css("top",(tip_btn.height()+40*TY.dpr)/2),waiting.css("top",(tip_btn.height()+40*TY.dpr)/2),warning.css("top",(tip_btn.height()+40*TY.dpr)/2),process_bar.css({width:$(window).width()-40*TY.dpr,height:20*TY.dpr,left:20*TY.dpr,bottom:25*TY.dpr}),process_bar.find(".process_btn").css("transform","scale("+TY.dpr+","+TY.dpr+")"),process_bar.find(".process_btn").css("bottom",-28-8*(TY.dpr-1)),process_bar.find(".process_bg").css("transform","scaleY("+TY.dpr+")"),process_bar.find(".process_line").css("transform","scaleY("+TY.dpr+")"),process_bar.find(".process_bg").css("width",process_bar.width()),process_bar.find(".process_line").css("width",0),process_forward.css("transform","scale("+TY.dpr+","+TY.dpr+")"),e.append(TY.templates.svg_template);var f,g,h=function(){var a=document.querySelector(".h5_player_tip_btn");a.addEventListener("touchstart",k),a.addEventListener("touchmove",l),a.addEventListener("touchend",m),document.querySelector(".h5_player_pause").addEventListener("touchend",function(a){a.stopPropagation(),d.paused?d.play():d.pause()}),document.querySelector(".process_btn").addEventListener("touchstart",o),document.querySelector(".process_btn").addEventListener("touchmove",p),document.querySelector(".process_btn").addEventListener("touchend",q),document.querySelector(".h5_player_process_bar").addEventListener("touchstart",r),document.querySelector(".h5_player_process_bar").addEventListener("touchmove",s),document.querySelector(".h5_player_process_bar").addEventListener("touchend",t)},i=0,j=0,k=function(a){a.stopPropagation(),i=a.touches[0].pageY},l=function(a){a.preventDefault(),a.stopPropagation(),j=a.touches[0].pageY},m=function(a){a.stopPropagation(),Math.abs(Math.abs(j)-Math.abs(i))<=5||0==j?d.paused?d.play():d.pause():"none"==process_bar.css("display")?_TYskin.showProcessBar():_TYskin.hideProcessBar(),i=0,j=0,_TYskin.dispatchEvent("VidoeClick",_TYskin)};_isProcessing=0,_isWaiting=0;var n,o=function(a){a.stopPropagation(),_isProcessing=1},p=function(a){a.preventDefault(),a.stopPropagation(),_isProcessing=1;var b=$(".process_btn"),c=$(".h5_player_process_bar"),e=a.touches[0].pageX-parseInt(c.css("left"))-parseInt(b.width())/4;0>e?e=0:e>c.width()-b.width()+parseInt(b.width())/2&&(e=c.width()-b.width()+parseInt(b.width())/2),f=e,_TYskin.setProcess(e),$(".h5_player_process_forward").show();var h=parseInt(d.duration),i=h*e/parseInt($(".process_bg").width());$(".h5_player_process_forward .time").html(TY.formatTime(i)),i>g&&$(".h5_player_process_forward .forward").css("transform","rotate(0deg)"),i<g&&$(".h5_player_process_forward .forward").css("transform","rotate(180deg)"),g=i},q=function(a){a.stopPropagation(),_isProcessing=0,$(".h5_player_process_forward").hide();var b=parseInt(d.duration),c=b*f/parseInt($(".process_bg").width());_TYskin.seek(c)},r=function(a){n=a.touches[0].pageX},s=function(a){a.preventDefault(),a.stopPropagation(),n=a.touches[0].pageX},t=function(a){var b=$(".process_btn"),c=$(".h5_player_process_bar"),e=n-parseInt(c.css("left"))-parseInt(b.width())/4;0>e?e=0:e>c.width()-b.width()+parseInt(b.width())/2&&(e=c.width()-b.width()+parseInt(b.width())/2),_TYskin.setProcess(e);var f=parseInt(d.duration),g=f*e/parseInt($(".process_bg").width()-b.width()+parseInt(b.width())/2);_TYskin.seek(g),n=0};_isLive?(document.querySelector(".h5_player_tip_btn").addEventListener("touchmove",function(a){a.preventDefault(),a.stopPropagation()}),document.querySelector(".h5_player_tip_btn").addEventListener("touchend",function(a){a.stopPropagation(),d.paused&&d.play(),_TYskin.dispatchEvent("VidoeClick",_TYskin)}),document.querySelector(".h5_player_pause").addEventListener("touchend",function(a){a.stopPropagation(),d.play()}),process_bar.hide()):h()},TY.TYskin.prototype={constructor:TY.TYskin,isFirstOpen:!0,showPause:function(){return!_isProcessing&&(!_isWaiting&&(pause.show(),pause.css("opacity",0),pause.css("transform","scale(.1,.1)"),void pause.animate({opacity:1,transform:"scale("+TY.dpr+","+TY.dpr+")"},100,"ease-out")))},hidePause:function(){pause.animate({opacity:0,transform:"scale("+2*TY.dpr+","+2*TY.dpr+")"},100,"ease-out",function(){pause.hide()})},showProcessBar:function(){process_bar.show(),_TYskin.updateBar(),process_bar.animate({transform:"translate(0px,0px)"},200,"ease-out")},hideProcessBar:function(){process_bar.animate({transform:"translate(0px,"+80*TY.dpr+"px)"},200,"ease-out",function(){process_bar.hide()})},hide_icon:function(){_TYskin.hidePause(),waiting.hide(),warning.hide(),tip_btn.css("margin-left","-1px")},updateBar:function(){if(_isLive)return!1;if(_isProcessing)return!1;var a=parseInt(_video.duration),b=parseInt(_video.currentTime),c=parseInt($(".process_bg").width()-$(".process_btn").width()/2+12)*b/a;_TYskin.setProcess(c)},setProcess:function(a){$(".process_line").css({width:a+10}),$(".process_btn").css({left:a})},seek:function(a){_video.currentTime=a},showWaiting:function(){return!_isProcessing&&(_TYskin.hide_icon(),_isWaiting=1,waiting.show(),waiting.css("opacity",0),waiting.css("transform","scale(.1,.1)"),void waiting.animate({opacity:1,transform:"scale("+TY.dpr+","+TY.dpr+")"},100,"ease-out"))},hideWaiting:function(){_isWaiting=0,waiting.animate({opacity:0,transform:"scale("+2*TY.dpr+","+2*TY.dpr+")"},100,"ease-out",function(){waiting.hide()})},showWarning:function(){return!_isProcessing&&(_TYskin.hide_icon(),warning.show(),warning.css("opacity",0),warning.css("transform","scale(.1,.1)"),void warning.animate({opacity:1,transform:"scale("+TY.dpr+","+TY.dpr+")"},100,"ease-out"))},removeThis:function(){}},TY.extend(TY.TYskin.prototype,TY.EventDispatcher.prototype),TY.TYplayer=function(a,b,c,d){function e(){player_bg.css("opacity",0),player_bg.css("transform","scale(1.5,1.5)"),player_bg.animate({opacity:1,transform:"scale(1,1)"},200,"ease-out")}function f(){player_bg.animate({opacity:0,transform:"scale(1.5,1.5)"},200,"ease-out",function(){player_bg.hide()})}function g(a){TY.Debug&&(TY.isWeixin?alert(a):console.log(a))}function h(a){if(a<300)setTimeout(function(){h(_video.clientHeight)},500);else{var b=$(window).height(),c=b-a;$("#video").css("margin-top",c)}}function i(a){a.addEventListener("error",j,!1),a.addEventListener("loadstart",function(){g("loadstart"),_skin.showWaiting()},!1),a.addEventListener("loadedmetadata",function(){},!1),a.addEventListener("loadeddata",function(){},!1),a.addEventListener("waiting",function(){g("waiting"),_skin.showWaiting()},!1),a.addEventListener("canplay",function(){g("canplay"),_skin.hideWaiting(),TY.isIphone&&f(),TY.isIphone&&h(a.clientHeight)},!1),a.addEventListener("canplaythrough",function(){},!1),a.addEventListener("play",function(){g("play"),_skin.isFirstOpen||f(),TY.isIphone&&h(a.clientHeight)},!1),a.addEventListener("playing",function(){g("playing"),_skin.isFirstOpen||_skin.hidePause(),_skin.isFirstOpen=!1},!1),a.addEventListener("pause",function(){g("pause"),_skin.showPause()},!1),a.addEventListener("ended",function(){g("ended"),_skin.seek(0),_TYplayer.dispatchEvent("VidoeEnd",_TYplayer)},!1),a.addEventListener("progress",function(){},!1),a.addEventListener("suspend",function(){},!1),a.addEventListener("abort",function(){},!1),a.addEventListener("stalled",function(){g("stalled")},!1),a.addEventListener("seeking",function(){g("seeking")},!1),a.addEventListener("seeked",function(){},!1),a.addEventListener("ratechange",function(){},!1),a.addEventListener("durationchange",function(){},!1),a.addEventListener("volumechange",function(){},!1),a.addEventListener("timeupdate",function(){k()},!1)}function j(){var a={};switch(a.code=_video.error.code,a.error="",a.code){case 1:a.error="播放过程中用户终止";break;case 2:a.error="播放过程中网络错误";break;case 3:a.error="播放过程中解码错误";break;case 4:a.error="播放过程中URL无效"}g("player VidoeError:"+a.error),_TYplayer.dispatchEvent("VidoeError",a),_skin.showWarning(),_skin.showWarning()}function k(){_skin.updateBar()}_TYplayer=this,_dom=$(b),TY.isAndroid&&(TY.dpr=1),_dom.append(TY.videoDiv),_player=_dom.find(".h5_player"),_player.append(TY.videoTemplate),_player.append(TY.videoBgTemplate),player_bg=$(".h5_player_bg"),player_bg.css("background-image","url("+c+")"),e(),_video=_player.find("video")[0],_video.src=a,g(_video),i(_video),_skin=new TY.TYskin(_video,_dom,d),_skin.showPause(),_skin.setProcess(0),_skin.addEventListener("VidoeClick",function(a){_TYplayer.dispatchEvent("VidoeClick",a)})},TY.TYplayer.prototype={constructor:TY.TYplayer,removeThis:function(){document.addEventListener("touchmove",function(a){}),_skin.removeThis(),_video.remove();for(var a=_dom.get(0),b=a.childNodes.length,c=0;c<b;++c)a.removeChild(a.childNodes[0])}},TY.extend(TY.TYplayer.prototype,TY.EventDispatcher.prototype);