...
TY.videoTemplate='<video id="video"  webkit-playsinline="true" x-webkit-airplay="true" x5-video-player-type="h5" playsinline width="100%"  preload="auto" poster="" src="'+TY.videoUrl+'" ></video>',TY.videoBgTemplate='<div class="h5_player_bg" style="position:absolute;width:100%;height:100%;top:0;background-position:center;background-size: cover; background-color:transparent;;background-image:url()"></div>',TY.dpr=window.devicePixelRatio||1,TY.isAndroid=/Android/i.test(navigator.userAgent),TY.isIphone=/iphone/i.test(navigator.userAgent),TY.isChrome=/chrome\//i.test(navigator.userAgent),TY.isWeixin=/MicroMessenger\//i.test(navigator.userAgent),TY.isWeibo=/Weibo/i.test(navigator.userAgent),TY.isMobileDevice=isMobileDevice,TY.isIosDevice=function(){var a=navigator.userAgent.toLowerCase(),b=!!a.match(/\(i[^;]+;( U;)? cpu.+mac os x/),c=a.indexOf("iphone")>-1||a.indexOf("Mac")>-1,d=a.indexOf("ipad")>-1;return!!(b||d||c)},TY.browserTypeInfo=function(){var a=navigator.userAgent.toLowerCase(),b=a.indexOf("trident")>-1,c=a.indexOf("presto")>-1,d=a.indexOf("applewebkit")>-1,e=a.indexOf("Gecko")>-1&&-1===a.indexOf("KHTML"),f=a.indexOf("chrome")>-1,g=!!a.match(/\(i[^;]+;( U;)? cpu.+mac os x/),h=a.indexOf("android")>-1||a.indexOf("Linux")>-1,i=a.indexOf("iphone")>-1||a.indexOf("Mac")>-1,j=a.indexOf("ipad")>-1,k=-1===a.indexOf("safari"),l={ie:b,op:c,wk:d,cr:f,mz:e,io:g,an:h,ih:i,id:j,wa:k};return l},TY.formatTime=function(a){var b="",c=parseInt(a),d=c%60,e=parseInt(c/60),f=0;return e>60&&(f=parseInt(e/60),e=parseInt(e%60)),10>e&&(e="0"+e),10>d&&(d="0"+d),10>f&&(f="0"+f),b=f+":"+e+":"+d},TY.EventDispatcher=function(){},TY.EventDispatcher.prototype={constructor:TY.EventDispatcher,addEventListener:function(a,b){return this._listeners?this.removeEventListener(a,b):this._listeners={},this._listeners[a]||(this._listeners[a]=[]),this._listeners[a].push(b),b},hasEventListener:function(a,b){var c=this._listeners;return!(!c||!c[a])},removeEventListener:function(a,b){if(this._listeners&&this._listeners[a])for(var c=this._listeners[a],d=0,e=c.length;d<e;d++)if(c[d]==b){1==e?delete this._listeners[a]:c.splice(d,1);break}},removeAllEventListeners:function(a){a?this._listeners&&delete this._listeners[a]:this._listeners=null},dispatchEvent:function(a,b){var c=!1,d=this._listeners;if(a&&d){var e=d[a];if(!e)return c;e=e.slice();for(var f,g=e.length;g--;){var f=e[g];c=c||f(b)}}return!!c}},TY.TYskin=function(a,b,c){var d=this;this.isToPlayed=!1,this._video=a,this._dom=b,this._isLive=c,this._isProcessing=0,this._isWaiting=0,this._dom.append(TY.templates.replay),this.pause=$(".h5_player_pause"),this.waiting=$(".h5_player_waiting"),this.warning=$(".h5_player_warning"),this.tip_btn=$(".h5_player_tip_btn"),this.process_bar=$(".h5_player_process_bar"),this.tip_btn.height(this.tip_btn.height()-60*TY.dpr),this.pause.css("top",(this.tip_btn.height()+40*TY.dpr)/2),this.waiting.css("top",(this.tip_btn.height()+40*TY.dpr)/2),this.warning.css("top",(this.tip_btn.height()+40*TY.dpr)/2),this.process_bar.css({width:$(window).width()-40*TY.dpr,height:20*TY.dpr,left:20*TY.dpr,bottom:25*TY.dpr}),this.process_bar.find(".process_btn").css("transform","scale("+TY.dpr+","+TY.dpr+")"),this.process_bar.find(".process_btn").css("bottom",-28-8*(TY.dpr-1)),this.process_bar.find(".process_bg").css("transform","scaleY("+TY.dpr+")"),this.process_bar.find(".process_line").css("transform","scaleY("+TY.dpr+")"),this.process_bar.find(".process_bg").css("width",this.process_bar.width()),this.process_bar.find(".process_line").css("width",0),this.process_bar.hide(),this.hideProcessBar(),$(".h5_player_process_forward").css("transform","scale("+TY.dpr+","+TY.dpr+")"),this._dom.append(TY.templates.svg_template);var e,f,g,h=function(){var a=document.querySelector(".h5_player_tip_btn");a.addEventListener("touchstart",k),a.addEventListener("touchmove",l),a.addEventListener("touchend",m),document.querySelector(".h5_player_pause").addEventListener("touchend",function(a){a.stopPropagation(),d._video.paused?d.toPlay():d.toPause(),d.dispatchEvent("VidoeClick",d)}),document.querySelector(".process_btn").addEventListener("touchstart",n),document.querySelector(".process_btn").addEventListener("touchmove",o),document.querySelector(".process_btn").addEventListener("touchend",p),document.querySelector(".h5_player_process_bar").addEventListener("touchstart",q),document.querySelector(".h5_player_process_bar").addEventListener("touchmove",r),document.querySelector(".h5_player_process_bar").addEventListener("touchend",s)},i=0,j=0,k=function(a){a.stopPropagation(),i=a.touches[0].pageY},l=function(a){a.preventDefault(),a.stopPropagation(),j=a.touches[0].pageY},m=function(a){a.stopPropagation(),Math.abs(Math.abs(j)-Math.abs(i))<=5||0==j?d._video.paused?d.toPlay():d.toPause():"none"==d.process_bar.css("display")?d.showProcessBar():d.hideProcessBar(),i=0,j=0,d.dispatchEvent("VidoeClick",d)},n=function(a){a.stopPropagation(),d._isProcessing=1},o=function(a){a.preventDefault(),a.stopPropagation(),d._isProcessing=1;var b=$(".process_btn"),c=$(".h5_player_process_bar"),g=a.touches[0].pageX-parseInt(c.css("left"))-parseInt(b.width())/4;0>g?g=0:g>c.width()-b.width()+parseInt(b.width())/2&&(g=c.width()-b.width()+parseInt(b.width())/2),e=g,d.setProcess(g),$(".h5_player_process_forward").show();var h=parseInt(d._video.duration),i=h*g/parseInt($(".process_bg").width());$(".h5_player_process_forward .time").html(TY.formatTime(i)),i>f&&$(".h5_player_process_forward .forward").css("transform","rotate(0deg)"),i<f&&$(".h5_player_process_forward .forward").css("transform","rotate(180deg)"),f=i},p=function(a){a.stopPropagation(),d._isProcessing=0,$(".h5_player_process_forward").hide();var b=parseInt(d._video.duration),c=b*e/parseInt($(".process_bg").width());d.seek(c)},q=function(a){g=a.touches[0].pageX},r=function(a){a.preventDefault(),a.stopPropagation(),g=a.touches[0].pageX},s=function(a){var b=$(".process_btn"),c=$(".h5_player_process_bar"),e=g-parseInt(c.css("left"))-parseInt(b.width())/4;0>e?e=0:e>c.width()-b.width()+parseInt(b.width())/2&&(e=c.width()-b.width()+parseInt(b.width())/2),d.setProcess(e);var f=parseInt(d._video.duration),h=f*e/parseInt($(".process_bg").width()-b.width()+parseInt(b.width())/2);d.seek(h),g=0};this._isLive?(document.querySelector(".h5_player_tip_btn").addEventListener("touchmove",function(a){a.preventDefault(),a.stopPropagation()}),document.querySelector(".h5_player_tip_btn").addEventListener("touchend",function(a){a.stopPropagation(),d._video.paused&&d.toPlay(),d.dispatchEvent("VidoeClick",d)}),document.querySelector(".h5_player_pause").addEventListener("touchend",function(a){a.stopPropagation(),d._video.paused&&d.toPlay(),d.dispatchEvent("VidoeClick",d)}),this.process_bar.hide()):h()},TY.TYskin.prototype={constructor:TY.TYskin,showPause:function(){return!this._isProcessing&&(!this._isWaiting&&(this.pause.show(),this.pause.css("opacity",0),this.pause.css("transform","scale(.1,.1)"),void this.pause.animate({opacity:1,transform:"scale("+TY.dpr+","+TY.dpr+")"},100,"ease-out")))},hidePause:function(){var a=this;this.pause.animate({opacity:0,transform:"scale("+2*TY.dpr+","+2*TY.dpr+")"},100,"ease-out",function(){a.pause.hide()})},showProcessBar:function(){this.isToPlayed&&(this.process_bar.show(),this.updateBar(),this.process_bar.animate({transform:"translate(0px,0px)"},300,"ease-out"))},hideProcessBar:function(){var a=this;this.process_bar.animate({transform:"translate(0px,"+80*TY.dpr+"px)"},300,"ease-out",function(){a.process_bar.hide()})},hide_icon:function(){this.hidePause(),this.waiting.hide(),this.warning.hide(),this.tip_btn.css("margin-left","-1px")},updateBar:function(){if(this._isLive)return!1;if(this._isProcessing)return!1;var a=parseInt(this._video.duration),b=parseInt(this._video.currentTime),c=parseInt($(".process_bg").width()-$(".process_btn").width()/2+12)*b/a;this.setProcess(c)},setProcess:function(a){$(".process_line").css({width:a+10}),$(".process_btn").css({left:a})},seek:function(a){this._video.currentTime=a},toPlay:function(){this._video.play(),this.isToPlayed||(TY.Log("isToPlayed"),this.isToPlayed=!0)},toPause:function(){this._video.pause()},showWaiting:function(){return!this._isProcessing&&(this.hide_icon(),this._isWaiting=1,this.waiting.show(),this.waiting.css("opacity",0),this.waiting.css("transform","scale(.1,.1)"),void this.waiting.animate({opacity:1,transform:"scale("+TY.dpr+","+TY.dpr+")"},100,"ease-out"))},hideWaiting:function(){var a=this;this._isWaiting=0,this.waiting.animate({opacity:0,transform:"scale("+2*TY.dpr+","+2*TY.dpr+")"},100,"ease-out",function(){a.waiting.hide()})},showWarning:function(){return!this._isProcessing&&(this.hide_icon(),this.warning.show(),this.warning.css("opacity",0),this.warning.css("transform","scale(.1,.1)"),void this.warning.animate({opacity:1,transform:"scale("+TY.dpr+","+TY.dpr+")"},100,"ease-out"))},removeThis:function(){}},TY.extend(TY.TYskin.prototype,TY.EventDispatcher.prototype),TY.TYplayer=function(a,b,c,d){function e(){if(!TY.isAndroid){var a=k._video.clientHeight,b=$(window).height(),c=b-a;$("#video").css("margin-top",c),setTimeout(function(){var a=k._video.clientHeight,b=$(window).height(),c=b-a;$("#video").css("margin-top",c)},1e3)}}function f(){$(".h5_player_bg").css("opacity",0),$(".h5_player_bg").css("transform","scale(1.5,1.5)"),$(".h5_player_bg").animate({opacity:1,transform:"scale(1,1)"},300,"ease-out")}function g(){"none"!=$(".h5_player_bg")[0].style.display&&setTimeout(function(){$(".h5_player_bg").animate({opacity:0,transform:"scale(1.5,1.5)"},300,"ease-out",function(){$(".h5_player_bg").hide()}),d||k._skin.showProcessBar()},300)}function h(a){a.addEventListener("error",i,!1),a.addEventListener("loadstart",function(){TY.Log("loadstart"),k._skin.showPause()},!1),a.addEventListener("loadedmetadata",function(){},!1),a.addEventListener("loadeddata",function(){},!1),a.addEventListener("waiting",function(){TY.Log("waiting"),k._skin.showWaiting()},!1),a.addEventListener("canplay",function(){TY.Log("canplay"),k._skin.hideWaiting()},!1),a.addEventListener("canplaythrough",function(){},!1),a.addEventListener("play",function(){TY.Log("play")},!1),a.addEventListener("playing",function(){TY.Log("playing"),k._skin.isToPlayed&&g(),k._skin.isToPlayed&&k._skin.hidePause(),e()},!1),a.addEventListener("pause",function(){TY.Log("pause"),k._skin.showPause()},!1),a.addEventListener("ended",function(){TY.Log("ended"),k._skin.seek(0),k.dispatchEvent("VidoeEnd",k)},!1),a.addEventListener("progress",function(){},!1),a.addEventListener("suspend",function(){},!1),a.addEventListener("abort",function(){},!1),a.addEventListener("stalled",function(){TY.Log("stalled")},!1),a.addEventListener("seeking",function(){TY.Log("seeking")},!1),a.addEventListener("seeked",function(){},!1),a.addEventListener("ratechange",function(){},!1),a.addEventListener("durationchange",function(){},!1),a.addEventListener("volumechange",function(){},!1),a.addEventListener("timeupdate",function(){j()},!1)}function i(){var a={};switch(a.code=k._video.error.code,a.error="",a.code){case 1:a.error="播放过程中用户终止";break;case 2:a.error="播放过程中网络错误";break;case 3:a.error="播放过程中解码错误";break;case 4:a.error="播放过程中URL无效"}TY.Log("player VidoeError:"+a.error),k.dispatchEvent("VidoeError",a),k._skin.showWarning(),k._skin.showWarning()}function j(){k._skin.updateBar()}var k=this;this._dom=$(b),TY.isAndroid&&(TY.dpr=1),this._dom.append(TY.videoDiv);var l=this._dom.find(".h5_player");l.append(TY.videoTemplate),l.append(TY.videoBgTemplate),$(".h5_player_bg").css("background-image","url("+c+")"),f(),this._video=l.find("video")[0],this._video.src=a,h(this._video),this._skin=new TY.TYskin(this._video,this._dom,d),this._skin.showPause(),this._skin.setProcess(0),this._skin.addEventListener("VidoeClick",function(a){k.dispatchEvent("VidoeClick",a),e()})},TY.TYplayer.prototype={constructor:TY.TYplayer,toPlay:function(){this._skin.toPlay()},removeThis:function(){document.addEventListener("touchmove",function(a){}),this._skin.removeThis(),this._video.remove();for(var a=this._dom.get(0),b=a.childNodes.length,c=0;c<b;++c)a.removeChild(a.childNodes[0])}},TY.extend(TY.TYplayer.prototype,TY.EventDispatcher.prototype);